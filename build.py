...
# Configuration (paths relative to this file's directory)
...
ACTS = [
    ...
    ,
    {
        ...
        "description": "Data lineage, claims registry, product catalog, design assets, and reports"
    }
]
...
def generate_research_tasks(missing_data):
    ...
    with open(ROOT_DIR / "RESEARCH_NEEDED.md", "w") as f:
        f.write("\n".join(output))
